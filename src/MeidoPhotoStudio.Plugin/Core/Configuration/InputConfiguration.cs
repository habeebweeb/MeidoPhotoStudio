...
public class InputConfiguration
{
    ...
    public InputConfiguration(ConfigFile configFile)
    {
        ...
        BindHotkey(Hotkey.GizmoFinger1, "Rotate First Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftControl, KeyCode.Alpha1));
        BindHotkey(Hotkey.GizmoFinger2, "Rotate Second Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftControl, KeyCode.Alpha2));
        BindHotkey(Hotkey.GizmoFinger3, "Rotate Third Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftControl, KeyCode.Alpha3));
        BindHotkey(Hotkey.GizmoFinger4, "Rotate Fourth Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftControl, KeyCode.Alpha4));
        BindHotkey(Hotkey.GizmoFinger5, "Rotate Fifth Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftControl, KeyCode.Alpha5));
        BindHotkey(Hotkey.TwistAllFingers, "Rotate Fingers", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift));
        BindHotkey(Hotkey.TwistFinger1, "Twist First Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift, KeyCode.Alpha1));
        BindHotkey(Hotkey.TwistFinger2, "Twist Second Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift, KeyCode.Alpha2));
        BindHotkey(Hotkey.TwistFinger3, "Twist Third Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift, KeyCode.Alpha3));
        BindHotkey(Hotkey.TwistFinger4, "Twist Fourth Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift, KeyCode.Alpha4));
        BindHotkey(Hotkey.TwistFinger5, "Twist Fifth Finger", new KeyboardHotkey(KeyCode.Space, KeyCode.LeftShift, KeyCode.Alpha5));
